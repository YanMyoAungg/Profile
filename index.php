    ...
    <div id="heroSection"
        ...
        <div id="welcome_modal" class="position-absolute w-100 h-100 d-flex align-items-center justify-content-center"
            ...
            <button type="button" class="btn-close position-absolute top-0 end-0 m-3 bg-white rounded-circle p-2"
                aria-label="Close" onclick="document.getElementById('welcome_modal').remove()"
                style="z-index: 11;"></button>

            <div class="container py-5 px-4"
                style="background-color: rgba(255, 255, 255, 0.95); border-radius: 15px; max-width: 800px; box-shadow: 0 8px 16px rgba(0,0,0,0.2);">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <p class="text-muted small mb-0">Already have an account? <a class="text-black" href="login.php">Login
                            here</a></p>
                </div>
            </div>
        </div>
    ...
    <div id="carouselExampleControls" class="carousel slide mb-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./resources/summber_festival.png" class="d-block w-100" alt="Event 1"
                    style="height: 400px; object-fit: contain; background-color: #333;">
            </div>
            <div class="carousel-item">
                <img src="./resources/culinary_workshops.png" class="d-block w-100" alt="Event 2"
                    style="height: 400px; object-fit: contain; background-color: #333;">
            </div>
            <div class="carousel-item">
                <img src="./resources/masterchef_meetup.png" class="d-block w-100" alt="Event 3"
                    style="height: 400px; object-fit: contain; background-color: #333;">
            </div>
        </div>

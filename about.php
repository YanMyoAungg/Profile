...
<div class="container mt-5">
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            ...
            <p class="lead">FoodFusion is more than just a recipe site; it's a global community for culinary exploration and education.</p>
            <p>Our mission is to empower home cooks and professional chefs alike by providing high-quality recipes, educational resources, and a platform to share their own culinary creations.</p>
        </div>
        <div class="col-md-6">

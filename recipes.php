            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <button type="button" class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#recipeModal<?= $recipe->id ?>">
                                View Recipe
                            </button>
                        </div>
                    </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php if ($recipe->image): ?>
                                <img src="<?= htmlspecialchars($recipe->image) ?>" class="img-fluid rounded mb-3" alt="<?= htmlspecialchars($recipe->title) ?>">
                            <?php endif; ?>
